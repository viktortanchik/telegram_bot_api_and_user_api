#  Добавлена возможность  получать имя канала при добавлении его в базу.
...
async def get_all_users(delay,channel):
    ...
    #channel_username = 'https://t.me/agrotsion'  # your channel

    channel_full_info = await client(GetFullChannelRequest(channel))
    #print("channel_full_info: ", type(channel_full_info))
   # print("channel_full_info: ", channel_full_info)
    chat_id = channel_full_info.full_chat.id
